...
function changeL(l)
	{
		...
		if (lights[l])
		{
			//document.getElementById('l' + l.toString()).setAttribute('style', "border:1px solid black; background-color: FloralWhite");
			document.getElementById('l' + l.toString()).setAttribute('class', "btn lightButtOn")
		}
		else
		{
			//document.getElementById('l' + l.toString()).setAttribute('style', "border:1px solid black; background-color: LightGrey");
...
function texture()
{
	document.getElementById('model__Line002-Texture').setAttribute('url', '"../sceneassets\\\\images/can_texture2.jpg"' );//document.getElementById('model3D');
}
